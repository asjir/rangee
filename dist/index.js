...
var RangeSerializer_1 = __webpack_require__(1);
var RangeCompressor_1 = __webpack_require__(3);
var RangeEncoder_1 = __webpack_require__(5);
    ...
    function Rangee(options) {
        ...
        this.getEncodedRange = function (range) {
            ...
            var serialized = partialRanges
                .map(function (range, index) { return RangeSerializer_1.default.serialize(range.cloneRange(), _this.options.document.body); })
                .map(function (r) { return JSON.stringify(r); })
                .join("|");
            var compressed = RangeCompressor_1.default.compress(serialized);
            var encoded = RangeEncoder_1.default.encode(compressed);
            return encoded;
        };
        this.getDecodedRanges = function (representation) {
            var decoded = RangeEncoder_1.default.decode(representation);
            var decompressed = RangeCompressor_1.default.decompress(decoded);
            var serializedRanges = decompressed
                .split("|")
                .map(function (r) { return JSON.parse(r); })
                .reverse()
                .map(function (r) { return RangeSerializer_1.default.deserialize(r, _this.options.document); });
        ...
        this.createPartialRanges = function (range) {
            ...
            // elements
            var treeWalker = _this.options.document.createTreeWalker(range.commonAncestorContainer, NodeFilter.SHOW_ALL, {
...
Object.defineProperty(exports, "__esModule", { value: true });
var HtmlElementSelectorGenerator_1 = __webpack_require__(2);
var HtmlDocumentRangeSerializer = /** @class */ (function () {
    ...
    HtmlDocumentRangeSerializer.prototype.serialize = function (range, relativeTo) {
        var start = HtmlElementSelectorGenerator_1.default.generateSelector(range.startContainer, relativeTo);
        start.offset = range.startOffset;
        var end = HtmlElementSelectorGenerator_1.default.generateSelector(range.endContainer, relativeTo);
        end.offset = range.endOffset;
        return { start: start, end: end };
    };
    HtmlDocumentRangeSerializer.prototype.deserialize = function (result, document) {
        var range = document.createRange();
        var startNode = HtmlElementSelectorGenerator_1.default.find(result.start, document);
        var endNode = HtmlElementSelectorGenerator_1.default.find(result.end, document);
...
exports.default = new HtmlDocumentRangeSerializer();
...
exports.default = new HtmlElementSelectorGenerator();
...
Object.defineProperty(exports, "__esModule", { value: true });
var lz_string_1 = __webpack_require__(4);
var RangeCompressor = /** @class */ (function () {
    function RangeCompressor() {
        this.compress = function (decompressed) { return lz_string_1.compressToUint8Array(decompressed); };
        this.decompress = function (compressed) { return lz_string_1.decompressFromUint8Array(compressed); };
    }
    return RangeCompressor;
}());
exports.default = new RangeCompressor();
...
exports.default = new RangeEncoder();
